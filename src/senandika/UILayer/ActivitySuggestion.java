...
public class ActivitySuggestion extends javax.swing.JFrame {
    ...
    public ActivitySuggestion(String idJournal, LocalDate tanggal,
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActivitySuggestion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ActivitySuggestion().setVisible(true);
            }
        });
    }
